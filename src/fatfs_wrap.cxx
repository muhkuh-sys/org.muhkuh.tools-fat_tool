...
#define SWIG_name      "fatfs"
#define SWIG_init      luaopen_fatfs
#define SWIG_init_user luaopen_fatfs_user
...
SWIGINTERN tBinaryDataFree fatfs_readfile(fatfs *self,char *pszPath){
		tBinaryDataFree tData;
		tData.pcData = self->readfile(pszPath, &tData.sizData);
		return tData;
	}
SWIGINTERN tBinaryData fatfs_readraw(fatfs *self,size_t sizOffset,size_t sizLen){
		tBinaryData tData;
		tData.pcData = self->readraw(sizOffset, sizLen);
		tData.sizData = sizLen;
		return tData;
	}
SWIGINTERN tBinaryData fatfs_getimage(fatfs *self){
		tBinaryData tData;	
...
extern "C" {
#endif
static int _wrap_fatfs_mkdir(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  char *arg2 = (char *) 0 ;
  bool result;
  
  SWIG_check_num_args("mkdir",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("mkdir",1,"fatfs *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("mkdir",2,"char *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs_mkdir",1,SWIGTYPE_p_fatfs);
  }
  
  arg2 = (char *)lua_tostring(L, 2);
  result = (bool)(arg1)->mkdir(arg2);
  SWIG_arg=0;
...
static int _wrap_fatfs_cd(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("cd",1,"fatfs *");
  if(lua_gettop(L)>=2 && !lua_isstring(L,2)) SWIG_fail_arg("cd",2,"char *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs_cd",1,SWIGTYPE_p_fatfs);
  }
  
  if(lua_gettop(L)>=2){
    arg2 = (char *)lua_tostring(L, 2);
  }
  result = (bool)(arg1)->cd(arg2);
  SWIG_arg=0;
  lua_pushboolean(L,(int)result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_fatfs_dir(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  char *arg2 = (char *) "." ;
  ...
  SWIG_check_num_args("dir",1,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("dir",1,"fatfs *");
  if(lua_gettop(L)>=2 && !lua_isstring(L,2)) SWIG_fail_arg("dir",2,"char *");
  if(lua_gettop(L)>=3 && !lua_isboolean(L,3)) SWIG_fail_arg("dir",3,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs_dir",1,SWIGTYPE_p_fatfs);
  }
  ...
  result = (bool)(arg1)->dir(arg2,arg3);
  SWIG_arg=0;
  lua_pushboolean(L,(int)result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_fatfs_writefile(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  char *arg2 = (char *) 0 ;
  size_t arg3 ;
  ...
  SWIG_check_num_args("writefile",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("writefile",1,"fatfs *");
  if(!lua_isstring(L,3)) SWIG_fail_arg("writefile",3,"char *");
...
static int _wrap_fatfs_writeraw(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  char *arg2 = (char *) 0 ;
  size_t arg3 ;
  ...
  SWIG_check_num_args("writeraw",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("writeraw",1,"fatfs *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("writeraw",3,"size_t");
...
static int _wrap_fatfs_deletefile(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  char *arg2 = (char *) 0 ;
  bool result;
  
  SWIG_check_num_args("deletefile",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("deletefile",1,"fatfs *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("deletefile",2,"char *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs_deletefile",1,SWIGTYPE_p_fatfs);
  }
  
  arg2 = (char *)lua_tostring(L, 2);
  result = (bool)(arg1)->deletefile(arg2);
  SWIG_arg=0;
  lua_pushboolean(L,(int)result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_fatfs_fileexists(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  char *arg2 = (char *) 0 ;
  bool result;
  
  SWIG_check_num_args("fileexists",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("fileexists",1,"fatfs *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("fileexists",2,"char *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs_fileexists",1,SWIGTYPE_p_fatfs);
  }
...
static int _wrap_fatfs___gc(lua_State* L) {
  ...
  SWIG_check_num_args("__gc",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("__gc",1,"fatfs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs___gc",1,SWIGTYPE_p_fatfs);
  }
...
static int _wrap_fatfs_readfile(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  char *arg2 = (char *) 0 ;
  tBinaryDataFree result;
  
  SWIG_check_num_args("readfile",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("readfile",1,"fatfs *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("readfile",2,"char *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs_readfile",1,SWIGTYPE_p_fatfs);
  }
  
  arg2 = (char *)lua_tostring(L, 2);
  result = fatfs_readfile(arg1,arg2);
  SWIG_arg=0;
  {
    if ((&result)->pcData != NULL) {
...
static int _wrap_fatfs_readraw(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  size_t arg2 ;
  size_t arg3 ;
  ...
  SWIG_check_num_args("readraw",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("readraw",1,"fatfs *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("readraw",2,"size_t");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("readraw",3,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs_readraw",1,SWIGTYPE_p_fatfs);
  }
  
  arg2 = (size_t)lua_tonumber(L, 2);
  arg3 = (size_t)lua_tonumber(L, 3);
  result = fatfs_readraw(arg1,arg2,arg3);
  SWIG_arg=0;
  {
    if ((&result)->pcData != NULL) {
      lua_pushlstring(L, (&result)->pcData, (&result)->sizData);
...
static int _wrap_fatfs_getimage(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  tBinaryData result;
  
  SWIG_check_num_args("getimage",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getimage",1,"fatfs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("fatfs_getimage",1,SWIGTYPE_p_fatfs);
  }
  
  result = fatfs_getimage(arg1);
  SWIG_arg=0;
  {
    if ((&result)->pcData != NULL) {
      lua_pushlstring(L, (&result)->pcData, (&result)->sizData);
...
static int _wrap_new_fatfs(lua_State* L) {
  ...
  SWIG_check_num_args("fatfs::fatfs",0,0)
  result = (fatfs *)new fatfs();
  SWIG_arg=0;
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_fatfs,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_delete_fatfs(lua_State* L) {
  int SWIG_arg = -1;
  fatfs *arg1 = (fatfs *) 0 ;
  
  SWIG_check_num_args("fatfs::~fatfs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("fatfs::~fatfs",1,"fatfs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fatfs,0))){
    SWIG_fail_ptr("delete_fatfs",1,SWIGTYPE_p_fatfs);
  }
...
static void swig_delete_fatfs(void *obj) {
fatfs *arg1 = (fatfs *) obj;
delete arg1;
}
static swig_lua_method swig_fatfs_methods[] = {
    {"mkdir", _wrap_fatfs_mkdir}, 
    {"cd", _wrap_fatfs_cd}, 
    {"dir", _wrap_fatfs_dir}, 
    {"writefile", _wrap_fatfs_writefile}, 
...
static swig_lua_class *swig_fatfs_bases[] = {0};
static const char *swig_fatfs_base_names[] = {0};
static swig_lua_class _wrap_class_fatfs = { "fatfs", &SWIGTYPE_p_fatfs,_wrap_new_fatfs, swig_delete_fatfs, swig_fatfs_methods, swig_fatfs_attributes, swig_fatfs_bases, swig_fatfs_base_names };
...
static const struct luaL_reg swig_commands[] = {
    { "fatfs_create", _wrap_fatfs_create},
    { "fatfs_mount", _wrap_fatfs_mount},
    {0,0}
};
